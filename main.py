...
def book_add():
    ...
    print(
        "Author:",
        books[titleEdited]['author'],
        "\nYear:",
        books[titleEdited]['year'],
        "\nGenre:",
        books[titleEdited]['genre'],
        "\nPages:",
        books[titleEdited]['pages'],
    )
...
def book_info():
    for key, value in books.items():
        print(key)
        print("Pages:", books[key]['pages'], "      Author:",
              books[key]['author'])
...
def modify_pages():
    ...
    while valid == False:
        ...
        newPages = input(
            "what do you want to change the pages to? \nplease enter a number:"
        )
        try:
...
def book_page_print():
    ...
    book = input(
        "please type a book title that you want to know the number of pages\n")
    ...
    while number == False:
        try:
            ...
            if int(pageTest) > 1:
                ...
                print('There are ' + pageTest +
                      ' pages in {}'.format(bookEdited))

                number = True

            elif int(pageTest) == 1:

                print('There is ' + pageTest +
                      ' page in {}'.format(bookEdited))
            ...
            print(
                "Oops, the book you have entered is not in the system - try again"
            )
